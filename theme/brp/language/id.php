...
$company = $CI->config->item('company');
	...
	$config['err_empty_npk']= "ID harap diisi!";
	$config['err_already_exist_npk']= "ID sudah ada!";	
	$config['err_not_already_exist_npk']= "ID belum ada!";
	$config['err_empty_pass']= "Password harap diisi!";
	$config['err_invalid_login']= "ID atau password salah!";	
	...
	$config['limportnpk_save']	= "Import ID berhasil.<br />Total data: %d<br />Total NPK: %d";
