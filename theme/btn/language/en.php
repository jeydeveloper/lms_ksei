...
$lnpk = "NIP";
	...
	$config['ldays'] 					= "day(s)";
	$config['err_empty_npk'] 			= "Please enter the ".$lnpk."!";
	$config['err_already_exist_npk'] 		= "This ".$lnpk."already registered. Please create another one.";	
	$config['err_not_already_exist_npk'] 	= "Your ".$lnpk." does not exist in the system. Please check and try again";
	...
	$config['lempty_npk']					= $lnpk." is empty.";
	$config['limportnpk_save']				= "Import succeded";
	$config['limportnpk_save']				= $lnpk." import succeeded. <br />Total data: %d<br />Total ".$lnpk.": %d";
	...
	$config['lconfirm_reset_all_npk'] 			= "Are You sure You want to reset all ".$lnpk." for this training/certificate?";
	$config['lconfirm_reset_periode'] 			= "Are You sure You want to reset all .".$lnpk." for this periode?";
	$config['lreset_npk_per_jabatan'] 			= "Are You sure You want reset all ".$lnpk." for this title?";
	$config['lreset_per_npk'] 				= "Are You sure You want to reset all data for this ".$lnpk."?";
	...
	$config['lnpk_classroom_not_exist'] 		= $lnpk." %s is not registered.";
...
//-- brp
	...
	$config['lsort_by_npk'] = "Sort by ".$lnpk;
	$config['lsort_by_hierarchy']	= "Sort by structure name";
	
	$config['linvalid_npk']	= "Invalid ".$lnpk;