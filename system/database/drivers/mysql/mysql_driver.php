...
class CI_DB_mysql_driver extends CI_DB {
	...
	function _execute($sql)
	{
		...
		$islog = ((substr($sql1, 0, strlen("INSERT")) == "INSERT") || (substr($sql1, 0, strlen("UPDATE")) == "UPDATE") || (substr($sql1, 0, strlen("DELETE")) == "DELETE") );				
	...
	function appendlog($log)
	{
		...
		$pathlog = $CI->config->item("MYSQL_PATH_LOG");
		$prefixlog = $CI->config->item("PREFIX_LOG");
