<?php
$config['err_empty_npk'] = "NIK harap diisi!";
$config['err_already_exist_npk'] = "NIK sudah ada!";
$config['err_not_already_exist_npk'] = "NIK belum ada!";
$config['err_empty_pass'] = "Password harap diisi!";
$config['err_invalid_login'] = "NIK atau password salah!";
...
$config['header_list_user'] = "Berikut adalah daftar karyawan :";
...
$config['header_list_directorat'] = "Berikut adalah nama direktorat yang tersedia dalam Learning Management System ini:";

$config['group_name'] = "Nama Grup";
$config['group'] = "Grup";
$config['group_list'] = "Daftar Grup";
$config['header_list_group'] = "Berikut adalah group yang ada dalam Learning Management System ini:";

$config['jabatan'] = "Jabatan";
$config['jabatan_list'] = "Daftar Jabatan";
$config['jabatan_name'] = "Nama Jabatan";
$config['header_list_jabatan'] = "Berikut adalah jabatan yang ada dalam Learning Management System ini:";
...
$config['header_list_function'] = "Berikut adalah function yang ada dalam Learning Management System ini:";
...
$config['header_list_category'] = "Berikut adalah kategori dari topik yang tersedia dalam Learning Management System ini:";

$config['ildp_category_list'] = "Daftar Kategori ILDP";
$config['ildp_header_list_category'] = "Berikut adalah kategori dari ILDP yang tersedia dalam Learning Management System ini:";
...
$config['llearning_topics'] = "Katalog";

$config['header_list_topic'] = "Berikut adalah daftar pembelajaran yang tersedia di Learning Management System ini:";

$config['password'] = "Kata kunci";
$config['forgot_password'] = "Lupa Password";
$config['email_not_in_db'] = "Email anda tidak di temukan di dalam database!";
$config['send_mail_failed'] = "Kirim email gagal. Harap kontak administrator!";
$config['password_resetter_mail_subject'] = "Learning Management System Password resetter";
...
$config['luser_name'] = "Nama Karyawan";
...
$config['lbanksoal_list_training'] = "Bank Soal Pra/Exam ";
...
$config['lheader_list_right'] = "Berikut adalah nama user group yang tersedia dalam Learning Management System ini:";
...
$config['lmax_err_login'] = "Anda telah mencapai maksimum error login. Harap hubungi administrator!";
$config['lexpired_password'] = "Password anda telah kadaluarsa. Harap ganti password anda!";
$config['lmax_user_login'] = "Terlalu banyak user yang login.Harap hubungi administrator!";
$config['lerr_inactiveperiod'] = "Akun Anda telah tidak aktif. Harap hubungi administrator!";
...
$config['llevel'] = "Level";
$config['lheader_list_level'] = "Berikut adalah hirarki yang tersedia dalam Learning Management System ini:";
...
$config['err_invalid_lastlogindate'] = "Tanggal terakhir login salah";
...
$config['lcetak'] = "Cetak";
$config['lcompeted'] = "Telah dilakukan";
...
$config['lheader_list_lokasi'] = "Berikut adalah daftar lokasi fisik yang tersedia dalam Learning Management System ini:";
...
$config['lclassroom_name'] = "Judul Training";
...
$config['lheader_list_category_jabatan'] = "Berikut adalah kategori dari jabatan yang tersedia dalam Learning Management System ini:";
...
$config['lheader_classroom_list'] = "Berikut adalah classroom yang ada dalam Learning Management System ini:";
...
$config['lheader_catalog_list'] = "Berikut adalah catalog yang ada dalam Learning Management System ini:";
$config['lheader_ildp_catalog_list'] = "Berikut adalah catalog ILDP yang ada dalam Learning Management System ini:";
$config['lheader_ildp_method_list'] = "Berikut adalah metode pembelajaran yang ada dalam Learning Management System ini:";
...
$config['lheader_lhrrm_setting_list'] = "Berikut adalah HR RM setting yang ada dalam Learning Management System ini:";
$config['lheader_lhrld_setting_list'] = "Berikut adalah HR L&D setting yang ada dalam Learning Management System ini:";
...
$config['lheader_my_ildp_form'] = "Berikut adalah ILDP Form dalam Learning Management System ini:";
...
$config['lheader_ildpform_list'] = "Berikut adalah ILDP Form yang ada dalam Learning Management System ini:";
...
$config['lildp_form_header'] = "Kategori - Fungsi";
$config['llearning_method_dev'] = "Aktifitas Pengembangan";
$config['lbudget'] = "Biaya (Rp.)";

$config['lerr_ildp_period'] = "Bukan dalam periode registrasi ILDP!";
$config['lerr_select_ildp_training_type'] = "Tipe Pelatihan harap dipilih!";
...
$config['lheader_ildp_registration_period'] = "Berikut adalah Periode pendaftaran ILDP yang ada dalam Learning Management System ini:";
...
$config['lempty_learning_method'] = "Aktifitas pengembangan harap diisi";
$config['lempty_timelines'] = "Periode harap dipilih";
...
$config['lsession'] = "Konfigurasi Session";
$config['lpassword_setting'] = "Konfigurasi Password";
$config['lelearning_setting'] = "Konfigurasi Pelatihan/Sertifikasi";

$config['lmultiple_login'] = "Multiple Login";
$config['lmultiple_login_description'] = "Multiple Login";
$config['lerr_multiple_login'] = "Login anda sudah dipergunakan di komputer lain";
$config['latasan'] = "Atasan";
$config['linvalid_atasan'] = "Invalid manager NIK";
$config['llast_date'] = "Last Date";

$config['ldeadline'] = "Deadline";
$config['lend_of'] = "pada akhir bulan";
...
$config['ltraining_setting'] = "Konfigurasi Pelatihan";
$config['lcertification_setting'] = "Konfigurasi Sertifikasi";

$config['lshow_print_certificate'] = "Tampilkan cetak sertifikat";
$config['lshow_min_lulus'] = "Tampilkan minimal nilai kelulusan";

$config['lshow_min_lulus_training_desc'] = "Tampilkan nilai minimal kelulusan setelah peserta menyelesaikan exam/praexam";
$config['lshow_print_certificate_training_desc'] = "Peserta dapat mencetak sertifikat pelatihan pada waktu lulus";

$config['lshow_print_certificate_desc'] = "Tampilkan nilai minimal kelulusan setelah peserta menyelesaikan sertifikasi";
$config['lshow_min_lulus_certificate_desc'] = "Peserta dapat mencetak sertifikat sertifikasi pada waktu lulus";

$config['lenablechangelanguange'] = "Tampilkan ganti bahasa setelah login";
$config['luser_activities'] = "Aktifitas karyawan";
$config['lonline_training'] = "Online Training";
$config['lall_access'] = "Semua akses";
$config['lfirst_access'] = "Akses pertama kali";
$config['llast_access'] = "Akses terakhir kali";
$config['lremove_all'] = "Hapus semua";

$config['lavailable_participant'] = "Peserta yang tersedia";
$config['lremove_all_confirmation'] = "Apakah anda yakin untuk menghapus semua peserta?";
$config['lselesai'] = "Selesai";

$config['lpraexam_participant_accessed'] = "Preexam - Jumlah peserta yang telah mengakses";
$config['lcertificate_name'] = 'Nama Sertifikasi';
$config['ltraining_name'] = 'Nama Pelatihan';
$config['lpraexam_participant_accessed_percent'] = "Praexam - Persentase peserta yang telah mengakses";
$config['lpraexam_participant_not_accessed_percent'] = "Praexam - Persentase peserta yang belum mengakses";
$config['lmaterial_participant_accessed'] = "Material - Jumlah peserta yang telah mengakses";
$config['lmaterial_participant_accessed_percent'] = "Material - Persentase peserta yang telah mengakses";
$config['lmaterial_participant_not_accessed_percent'] = "Material - Persentase peserta yang belum mengakses";
$config['lexam_participant_accessed'] = "Exam - Jumlah peserta yang telah mengakses";
$config['lexam_participant_accessed_percent'] = "Exam - Persentase peserta yang telah mengakses";
$config['lexam_participant_not_accessed_percent'] = "Exam - Persentase peserta yang belum mengakses";
$config['lcertification_participant_accessed'] = "Sertifikasi - Jumlah peserta yang telah mengakses";
$config['lcertification_participant_accessed_percent'] = "Sertifikasi - Persentase peserta yang telah mengakses";
$config['lcertification_participant_not_accessed'] = "Sertifikasi - Jumlah peserta yang belum mengakses";
$config['lcertification_participant_not_accessed_percent'] = "Sertifikasi - Persentase peserta yang belum mengakses";

$config['lcertificate_code'] = "Kode Sertifikasi";
$config['ladd_unit_soal'] = "Tambah Unit Soal";
$config['lresources_name'] = "Nama Sumber";
$config['lmaxtaken_praexam'] = "Anda telah mencapai batas pengambilan praexam";
$config['lmaxtaken_exam'] = "Anda telah mencapai batas pengambilan exam";
$config['lmaxtaken_certificate'] = "Anda telah mencapai batas pengambilan sertifikasi";

$config['lmail_notification'] = "Notifikasi mail";
$config['ltown'] = "Kota";
$config['lnilai'] = "Nilai";
$config['llulus_tidak'] = "Lulus/Tidak Lulus";
$config['lcertificate_no'] = "No. Sertifikat";
$config['lduration_second'] = "Durasi(detik)";
$config['lemail'] = "Email";
...
$config['lsulit'] = "Sulit";
$config['lmudah'] = "Mudah";
$config['lsort_by_topic_code'] = "Urut berdasar kode topik";
$config['lsort_by_topic_name'] = "Urut berdasar nama topik";
$config['lsort_by_category_name'] = "Urut berdasar nama kategori";
$config['lsort_by_status'] = "Urut berdasar status";
$config['lsort_by_training_name'] = "Urut berdasar nama pelatihan";
$config['lsort_by_certification_name'] = "Urut berdasar nama sertifikasi";
$config['lsort_by_training_code'] = "Urut berdasar kode pelatihan";
$config['lsort_by_certification_code'] = "Urut berdasar kode sertifikasi";
$config['lclose'] = "Tutup";
$config['ltime'] = "Waktu";
$config['lpasschange1stdescription'] = "Password harus diganti pada saat pertama kali login";
$config['lmaximumtakendescription'] = "Jumlah maksimum pengambilan pelatihan dalam 1 hari";
$config['lshow_materi_history_description'] = "Tampilkan matery history di learning profile";

$config['errprivillege_certification'] = "Anda tidak terdaftar dalam Sertifikasi ini";
$config['errprivillege_training'] = "Anda tidak terdaftar dalam pelatihan ini";
$config['errprivillege'] = "Anda tidak terdaftar"; // u/ pelatihan  / sertifikasi
$config['errinperiod'] = "Periode telah berakhir";

$config['errinperiod_training'] = "Periode pelatihan telah berakhir";
$config['errinperiod_certification'] = "Periode sertifikasi telah berakhir";
$config['id_jabatan'] = "Id jabatan";
$config['employee_status'] = "Status karyawan";
$config['employee_status_code'] = "Kode status karyawan";
$config['status_code'] = "Kode status";
$config['location_code'] = "Kode Lokasi Fisik";

$config['ltown_code'] = "Kode Kota";
$config['lsort_by_resource_name'] = "Urut berdasar nama resource";
$config['lsort_by_size'] = "Urut berdasar ukuran file";
$config['lsort_by_filetype'] = "Urut berdasar tipe file";

$config['lsort_by_npk'] = "Urut berdasar NIK";
$config['lsort_by_name'] = "Urut berdasar nama pengguna";
$config['lsort_by_email'] = "Urut berdasar email";
$config['lsort_by_position'] = "Urut berdasar jabatan";
$config['lsort_by_score'] = "Urut berdasar nilai";
$config['lsort_by_training_cert_name'] = "Urut berdasar nama pelatihan/sertifikasi";
$config['lsort_by_date'] = "Urut berdasar tanggal";
$config['lsort_by_position_name'] = "Urut berdasar nama jabatan";
$config['lsort_by_hierarchy'] = "Urut berdasar nama hirarki";
$config['lsort_list_by_usergroupname'] = "Urut berdasar nama grup pengguna";
$config['lsort_by_location'] = "Urut berdasar lokasi";
$config['lsort_by_city'] = "Urut berdasar kota";

$config['lreset_datelogin'] = "Reset tanggal login";
$config['lreset_datelogin_tooltips'] = "Reset tanggal terakhir login ke hari ini";
$config['lerr_max_taken_per_day'] = "Anda telah mencapai batas pengambilan pelatihan.";
$config['errinvalidprivileges'] = "Invalid privileges";
$config['errnotisinperiod'] = "Not in period";

$config['lcourse_abb'] = "Course Abb";
$config['ldevelopment_area'] = "Area Pengembangan";
$config['linput_abb'] = "Course Abb harap diisi!";
$config['lcourse_abbr_already_exists'] = "Course Abb sudah ada!";
$config['ladd'] = "Tambah";
$config['lempty_dev_area'] = "Area Pengembangan harap diisi!";
$config['lcategory'] = "Kategori";
$config['lcareer_aspiration'] = "Aspirasi Karir";
$config['lshort_term'] = "Jangka Pendek (1-3 tahun)";
$config['llong_term'] = "Jangka Panjang(>5 tahun)";
$config['lshort_term_description'] = "Short Term";
$config['llong_term_description'] = "Long Term";

$config['limport_training_history'] = "Import Histori Pelatihan";
$config['lbrowse_file_csv'] = "Browse File (csv)";
$config['linvalid_npk'] = "NIK Salah";
$config['ltraining_not_found'] = "Pelatihan tidak ditemukan";
$config['limporthistory_save'] = "Total data: %d , Total diimport: %d , Total diskip : %d";
$config['ltype_area_development'] = "Type untuk area development";
$config['lfree_text'] = "Free Text";
$config['ldropbox'] = "Drop Box";

$config['lempty_user_file_csv'] = "Harap pilih file (csv)";
$config['lout_of_ildp_period'] = "Sudah di luar Periode ILDP";
...
$config['news_desc'] = "Deskripsi";
$config['news_image'] = "Gambar";
$config['lsort_by_news_title'] = "Urut berdasar news title";
...
$config['err_invalid_login_new'] = "Email atau password salah!";
$config['llogin_by_email'] = "Login dengan email";

$config['lsort_by_news_entrydate'] = "Urut berdasar news entrydate";
$config['news_entrydate'] = "Tanggal";
...
//login base lang
$config['login_welcome_back'] = "Selamat Datang Kembali!";
$config['login_please_login'] = "Silahkan Login";
$config['login_nik'] = "NIK";
$config['login_email'] = "Email";
$config['login_password'] = "Password";
$config['login_forgot_password'] = "Lupa Password?";
$config['login_button_login'] = "Login";
$config['login_choose_language'] = "Pilih Bahasa";