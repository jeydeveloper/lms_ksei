<?php
$config['ldays'] = "day(s)";
$config['err_empty_npk'] = "Please type a your NIK!";
$config['err_already_exist_npk'] = "NIK is already exist!";
$config['err_not_already_exist_npk'] = "NIK is not already exist!";
$config['err_empty_pass'] = "Please type a your password!";
$config['err_invalid_login'] = "Invalid NIK or password!";
...
$config['header_list_user'] = "These are the users of LMS:";
...
$config['header_list_directorat'] = "These are directorate that available in this Learning Management System:";

$config['group_name'] = "Group Name";
$config['group'] = "Group";
$config['group_list'] = "Group List";
$config['header_list_group'] = "These are the groups available in this Learning Management System:";

/*$config['Position'] 			= "Position";
$config['Position_list'] 		= "Position List";
$config['Position_name'] 		= "Position Name";*/
$config['jabatan'] = "Position";
$config['jabatan_list'] = "Daftar Jabatan";
$config['jabatan_name'] = "Nama Jabatan";
$config['header_list_jabatan'] = "These are the positions available in this Learning Management System:";
$config['err_jabatan_name'] = "Please type your jabatan!";
$config['err_exist_jabatan'] = "Position is already exist!";
$config['err_not_exist_jabatan'] = "Position is not exist!";
...
$config['header_list_unit'] = "These are the units available in this Learning Management System:";
...
$config['department'] = "Division";
$config['department_list'] = "Department List";
$config['department_name'] = "Department Name";
$config['header_list_department'] = "These are the departments available in this Learning Management System:";

$config['function'] = "Function";
$config['function_list'] = "Function List";
$config['function_desc'] = "Function Description";
$config['header_list_function'] = "These are the functions available in this Learning Management System:";
...
$config['err_invalid_lastlogindate'] = "Invalid last login date";

$config['active'] = "Active";
$config['inactive'] = "Not Active";
...
$config['ok_update_training'] = "Training has been updated";
$config['ok_update_certificate'] = "Certificate has been updated";
$config['ok_update_classroom'] = "Classroom has been updated";
...
$config['ildp_header_list_category'] = "Below are ILDP Categories available in this Learning Management System:";
...
$config['header_list_category'] = "These are available categories in this Learning Management System:";
...
$config['header_list_topic'] = "These are the available titles in this Learning Management System:";
...
$config['password_resetter_mail_subject'] = "This Learning Management System Password resetter";
...
$config['certificate_time'] = "Certification Date";
$config['ldate'] = "Date";
$config['until'] = "until";
...
$config['all_position'] = "All position";
$config['all_function'] = "All function";
$config['all_status_emp'] = "All employee status";
...
$config['lTotal_question'] = "Total question";
$config['lbanksoal_name'] = "Bank Soal Name";
$config['lfile'] = "File";
...
$config['ledit_Question'] = "Edit Question";
$config['lerr_empty_question'] = "Please type your question!";
$config['lerr_empty_answer'] = "Please type your answer!";
$config['ok_update_Question'] = "Question has been updated!";
$config['lQuestion_not_exist'] = "Question not exist!";
$config['ok_add_Question'] = "Question has been added!";
...
$config['lduration_per_question'] = "Duration per question";
$config['lduration_per_soal'] = "Duration per question";
$config['lsecond'] = "second";
$config['ok_update_setting'] = "Setting has been updated!";
$config['linvalid_duration'] = "Invalid Duration";
...
$config['lheader_list_right'] = "These are the available user groups in this Learning Management System:";
...
$config['ljumlah_soal'] = "Number of questions";
$config['lerr_empty_jmsoal'] = "Please type total question!";
$config['lerr_invalid_jmsoal'] = "Invalid total question!";
...
$config['lunit_question'] = "Unit question";
$config['lunit_question_name'] = "Unit question Name";
$config['ladd_unitquestion'] = "Add Unit question";
$config['lerr_empty_unitquestion'] = "Please type unit question name!";
$config['lerr_exist_unitquestion'] = "Unit question name is already exist!";
$config['lerr_empty_file_unitquestion'] = "Please choose unit soal file!";
$config['lerr_invalid_file_unitquestion'] = "Invalid unit soal file!";
$config['lerr_invalid_file_unitquestion_jposition'] = "Position Name ( %s ) in the unit question the file has not created!";
$config['lunit_soal_question'] = "Pertanyaan Unit question";
...
$config['lerr_empty_jmsoal_defsetting'] = "Please type your default setting for numbers of questions";
$config['lerr_invalid_jmsoal_defsetting'] = "Your setting for numbers of questions is invalid";

$config['lerr_empty_bobotmudah_defsetting'] = "Please type your default easy level questions setting";
$config['lerr_invalid_bobotmudah_defsetting'] = "Your easy level questions setting is invalid";

$config['lerr_empty_bobotsedang_defsetting'] = "Please type your default medium level questions settings";
$config['lerr_invalid_bobotsedang_defsetting'] = "Your medium level questions setting is invalid";

$config['lerr_empty_bobotsulit_defsetting'] = "Please type your default difficult level questions setting";
$config['lerr_invalid_bobotsulit_defsetting'] = "Your difficult level questions setting is invalid";

$config['lerr_invalid_total_bobot'] = "The questions leveling setting is invalid";
...
$config['lerrprequisite_message'] = "Some prerequsites are not yet completed. Please finish the required courses.";
$config['lerror_login_description'] = "Maximum login error trial";
$config['lprerequisite_info'] = "T = Training  , C=Certification  , Ca = Classroom ";
$config['lsudah'] = "Completed";
$config['lbelum'] = "Not yet completed";
...
$config['lmax_err_login'] = "You have reached maximum error login. Please contact your administrator!";
...
$config['lerr_inactiveperiod'] = "Your account has been inactive. Please contact administrator!";
...
$config['llevel'] = "Level";
$config['lheader_list_level'] = "These are the available hierarchy in this Learning Management System:";
...
$config['lall_npk'] = "All NIK";
$config['err_empty_participant'] = "Participant list is still empty";
$config['ldelete'] = "Delete";
$config['lerr_empty_levelgroup'] = "Please choose group!";
...
$config['lerr_choose_npk'] = "Please choose npk!";
$config['lcost'] = "Cost";
...
$config['needmateri'] = "Sebelum melakukan exam, Anda harus membaca materi terlebih dahulu.";
...
$config['llokasi_list'] = "Location List";
$config['lheader_list_lokasi'] = "These are the listed locations:";
...
$config['limport_npk'] = "Import NIK";
$config['lempty_filenpk'] = "Choose NIK file";
$config['lempty_npk'] = "Tidak ada data NIK";
$config['limportnpk_save'] = "Import berhasil";
$config['limportnpk_save'] = "Import NIK berhasil.<br />Total data: %d<br />Total NIK: %d";
...
$config['lconfirm_reset_all_npk'] = "Are you sure to reset all npk for this training/certificate?";
$config['lconfirm_reset_periode'] = "Are you sure to reset all npk for this periode?";
$config['lreset_npk_per_jabatan'] = "Are you sure to reset all npk for this title?";
$config['lreset_per_npk'] = "Are you sure to reset all npk for this NIK?";
...
$config['lnpk_classroom_not_exist'] = "NIK %s belum ada.";
...
$config['lcategory_jabatan_list'] = "List of Position Categories";
$config['lheader_list_category_jabatan'] = "These are the listed categories:";
$config['ladd_category_jabatan'] = "Add Position Category";
$config['lmodify_category_jabatan'] = "Modify Position Category";
$config['ok_add_category_jabatan'] = "Position Category has been added";
$config['ok_update_category_jabatan'] = "Position Category has been updated.";
...
$config['lheader_classroom_list'] = "These are the listed classroom training:";
$config['ltype'] = "Type";
...
$config['limport_refreshment'] = "NIK Import For Refreshment";
...
$config['lheader_catalog_list'] = "These are the listed catalog:";
$config['lheader_ildp_catalog_list'] = "Below are the available ILDP Catalogs:";
$config['lheader_ildp_method_list'] = "Below are the listed learning methods:";
...
$config['lheader_lhrrm_setting_list'] = "Below are the HR RM Setting:";
$config['lheader_lhrld_setting_list'] = "Below are the HR LD Setting:";
...
$config['lheader_lhrld_setting_list'] = "Berikut adalah HR L&D setting yang ada dalam On-line Learning System ini:";
...
$config['lheader_my_ildp_form'] = "Berikut adalah ILDP Form dalam On-line Learning System ini:";
$config['lthen'] = "Then";
...
$config['lheader_ildpform_list'] = "Berikut adalah ILDP Form yang ada dalam On-line Learning System ini:";
...
$config['lildp_form_header'] = "Category - Function";
$config['llearning_method_dev'] = "Development Activities";
...
$config['lheader_ildp_registration_period'] = "Below are the ILDP Registration Period available in this On-line Learning System:";
...
$config['lempty_learning_method'] = "Please select a development activities";
$config['lempty_timelines'] = "Please select period";
...
$config['lcertificate_template'] = "Certificate template";
$config['lcertificate_template_desc'] = "Certificate template";
$config['lerr_certificate_template'] = "Invalid certificate template";
$config['lerr_training_template'] = "Invalid training template";

$config['lsetting_minpasswordlength'] = "Minimal password length";
$config['lsetting_minpasswordlength_description'] = "Minimal password length";
$config['lsetting_maxpasswordlength'] = "Maximal password length";
$config['lsetting_maxpasswordlength_description'] = "Maximal password length";

$config['lsetting_passwordchar'] = "Password character";
$config['lsetting_passwordchar_description'] = "Password character";

$config['lsetting_passchar_alphanumeric'] = "Alphanumeric";
$config['lsetting_passchar_free'] = "Free";

$config['lerr_invalid_minpasslen'] = "Invalid minimal password length!";
$config['lerr_invalid_maxpasslen'] = "Invalid maximum password length!";
$config['lerr_invalid_minpasslen_greater_maxpasslen'] = "Maximum password length must be greater than minimum password length!";

$config['lerr_invalid_minpasslen1'] = "Minimum password length is %d";
$config['lerr_invalid_maxpasslen1'] = "Maximum password length is %d";
$config['lerr_invalid_pass_alphanumeric'] = "Password must contains alphanumeric character!";

$config['ltraining_template_print'] = "Training template";
$config['ltraining_template_print_desc'] = "Training template";

$config['lsession'] = "Session Setting";
$config['lpassword_setting'] = "Password Setting";
$config['lelearning_setting'] = "Training/Certification Setting";

$config['lmultiple_login'] = "Multiple Login";
$config['lmultiple_login_description'] = "Multiple Login";
$config['lerr_multiple_login'] = "You are already logged in another machine";
$config['latasan'] = "Atasan";
$config['linvalid_atasan'] = "Invalid manager NIK";
$config['llast_date'] = "Last Date";

$config['ldeadline'] = "Deadline";
$config['lend_of'] = "by End Of";
...
$config['hierarchy_id'] = "Hierarchy Id";
$config['hierarchy_name'] = "Hierarchy Name";

$config['ltraining_setting'] = "Training Setting";
$config['lcertification_setting'] = "Certification Setting";

$config['lshow_print_certificate'] = "Show print certificate";
$config['lshow_min_lulus'] = "Show minimal passing grade";

$config['lshow_min_lulus_training_desc'] = "Show minimal passing grade after user finish the exam/praexam";
$config['lshow_print_certificate_training_desc'] = "User can print their own training certificate when they passed";

$config['lshow_print_certificate_desc'] = "Show minimal passing grade after user finish the certification";
$config['lshow_min_lulus_certificate_desc'] = "User can print their own certification certificate when they passed";

$config['lenablechangelanguange'] = "Show Change Language after login";
$config['luser_activities'] = "User Activities";
$config['lonline_training'] = "Online Training";
$config['lall_access'] = "All Access";
$config['lfirst_access'] = "First Access";
$config['llast_access'] = "Last Access";
$config['lremove_all'] = "Remove All";
$config['lavailable_participant'] = "Available Participant";

$config['lremove_all_confirmation'] = "Are you sure to delete all participant?";
$config['lselesai'] = "Finish";

$config['lpraexam_participant_accessed'] = "Preexam - Number of Participant Has Accessed";
$config['lcertificate_name'] = 'Certification Name';
$config['ltraining_name'] = 'Training Name';
$config['lpraexam_participant_accessed_percent'] = "Preexam - Percentage of Participant Has Accessed";
$config['lpraexam_participant_not_accessed_percent'] = "Preexam - Percentage of Participant Has not Accessed";
$config['lmaterial_participant_accessed'] = "Material - Number of Participant Has Accessed";
$config['lmaterial_participant_accessed_percent'] = "Material - Percentage of Participant Has Accessed";
$config['lmaterial_participant_not_accessed_percent'] = "Material - Percentage of Participant Has not Accessed";
$config['lexam_participant_accessed'] = "Exam - Number of Participant Has Accessed";
$config['lexam_participant_accessed_percent'] = "Exam - Percentage of Participant Has Accessed";
$config['lexam_participant_not_accessed_percent'] = "Exam - Percentage of Participant Has not Accessed";
$config['lcertification_participant_accessed'] = "Certification - Number of Participant Has Accessed";
$config['lcertification_participant_accessed_percent'] = "Certification - Percentage of Participant Has Accessed";
$config['lcertification_participant_not_accessed'] = "Certification - Number of Participant Has not Accessed";
$config['lcertification_participant_not_accessed_percent'] = "Certification - Percentage of Participant Has not Accessed";

$config['lcertificate_code'] = "Certification Code";
$config['ladd_unit_soal'] = "Add Question Unit";

$config['lresources_name'] = "Resources Name";
$config['lmaxtaken_praexam'] = "You have already taken the maximum number of preexam";
$config['lmaxtaken_exam'] = "You have already taken the maximum number of exam";
$config['lmaxtaken_certificate'] = "You have already taken the maximum number of certification";

$config['lmail_notification'] = "Mail notification";
$config['ltown'] = "Town";
$config['lnilai'] = "Value";
$config['llulus_tidak'] = "Passed/Failed";
$config['lcertificate_no'] = "Certificate Number";
$config['lduration_second'] = "Duration(seconds)";
$config['lemail'] = "Email";
$config['ldelete_session'] = "Delete session";
$config['ldelete_session_successfully'] = "User session has been removed";
$config['lshowildp'] = "Show ILDP";
$config['lall_status'] = "All Status";
$config['lsedang'] = "Average";
$config['lsulit'] = "Difficult";
$config['lmudah'] = "Easy";
$config['lsort_by_topic_code'] = "Sort By Topic Code";
$config['lsort_by_topic_name'] = "Sort By Topic Name";
$config['lsort_by_category_name'] = "Sort By Category Name";
$config['lsort_by_status'] = "Sort By Status";
$config['lsort_by_training_name'] = "Sort By Training Name";
$config['lsort_by_certification_name'] = "Sort By Certification Name";
$config['lsort_by_training_code'] = "Sort By Training Code";
$config['lsort_by_certification_code'] = "Sort By Certification Code";
$config['lclose'] = "Close";
$config['ltime'] = "Time";
$config['lpasschange1stdescription'] = "Must change password when first login";

$config['lmaximumtakendescription'] = "Maximum number of training can be taken in 1 day";
$config['lshow_materi_history_description'] = "Show materi history on learning profile";
$config['errprivillege'] = "You are not registered";  //u/ participant training/sertification
$config['errinperiod'] = "Period is over";

$config['errprivillege_certification'] = "You are not registered in this certification";
$config['errprivillege_training'] = "You are not registered in this training";
$config['errinperiod_training'] = "The Training Period is over";
$config['errinperiod_certification'] = "The Certification Period is over";
$config['id_jabatan'] = "Position id";

$config['employee_status'] = "Employee status";
$config['employee_status_code'] = "Employee status code";
$config['status_code'] = "Status Code";
$config['location_code'] = "Physical Location Code";
$config['ltown_code'] = "Town Code";
$config['lsort_by_resource_name'] = "Sort by resource name";
$config['lsort_by_size'] = "Sort by filesize";
$config['lsort_by_filetype'] = "Sort by file type";

$config['lsort_by_npk'] = "Sort by NIK";
$config['lsort_by_name'] = "Sort by username";
$config['lsort_by_email'] = "Sort by email";
$config['lsort_by_position'] = "Sort by position";

$config['lsort_by_score'] = "Sort by score";
$config['lsort_by_training_cert_name'] = "Sort by training/certification name";
$config['lsort_by_date'] = "Sort by date";
$config['lsort_by_position_name'] = "Sort by position name";
$config['lsort_by_hierarchy'] = "Sort by Hierarchy Name";
$config['lsort_list_by_usergroupname'] = "Sort by user group name";
$config['lsort_by_location'] = "Sort by location";
$config['lsort_by_city'] = "Sort by city";
$config['lreset_datelogin'] = "Reset date login";
$config['lreset_datelogin_tooltips'] = "Reset last date login to today";

$config['lerr_max_taken_per_day'] = "You have already taken the maximum number of training.";
$config['errinvalidprivileges'] = "Invalid privileges";
$config['errnotisinperiod'] = "Not in period";

$config['lcourse_abb'] = "Course Abb";
$config['ldevelopment_area'] = "Area of Development";
$config['linput_abb'] = "Please input Course Abb";
$config['lcourse_abbr_already_exists'] = "Course Abb already exists!";
$config['ladd'] = "Add";
$config['lempty_dev_area'] = "Please input development area!";
$config['lcategory'] = "Category";
$config['lcareer_aspiration'] = "Career Aspirations";
$config['lshort_term'] = "Short Term (1-2 Years)";
$config['llong_term'] = "Long Term (>5 Years)";
$config['lshort_term_description'] = "Short Term";
$config['llong_term_description'] = "Long Term";

$config['limport_training_history'] = "Import Training History";
$config['lbrowse_file_csv'] = "Browse File (csv)";
$config['linvalid_npk'] = "Invalid NIK";
$config['ltraining_not_found'] = "Training not found";

$config['limporthistory_save'] = "Total data : %d , Total imported: %d , Total Skipped : %d";
$config['ltype_area_development'] = "Type untuk area development";
$config['lfree_text'] = "Free Text";
$config['ldropbox'] = "Drop Box";

$config['lempty_user_file_csv'] = "Please choose user file (csv)";
$config['lout_of_ildp_period'] = "Out of ILDP Period";

//--------admin news------
$config['ladmin_news'] = "Admin News";
$config['list_news'] = "List News";
$config['archive_news'] = "Archive News";

$config['ladmin_news_list'] = "Admin News List";
$config['lheader_list_news_list'] = "Berikut adalah daftar dari cms news yang tersedia di Learning Management System:";
$config['news_title'] = "News Title";
$config['news_desc'] = "Description";
$config['news_image'] = "Picture";
$config['lsort_by_news_title'] = "Sort by news title";

$config['ladd_news_list'] = "Add News List";
$config['lmodify_news_list'] = "Modify News List";

$config['lsetting_cms_admin'] = "Setting CMS Admin";
$config['lcms_admin_activity_periodic'] = "Day Activity";
$config['lcms_admin_activity_periodic_description'] = "Interval day untuk activity";
$config['lnews_per_page'] = "News Per Page";
$config['lnews_per_page_description'] = "Total News Per Page";
$config['lshow_admin_news'] = "Show Admin News";
$config['lshow_admin_news_description'] = "Show Admin News";

$config['ladd_reminder'] = "Add New";
$config['ladd_refreshment'] = "Add New";

$config['err_invalid_login_new'] = "Invalid email or password!";
$config['llogin_by_email'] = "Login by email";

$config['lsort_by_news_entrydate'] = "Sort by news entrydate";
$config['news_entrydate'] = "Date";

//wording proposal training
$config['lproposal_training'] = "Proposal Training";
$config['lproposal_admin_approval'] = "Admin Approval";
$config['lproposal_admin_approval_description'] = "Admin Approval Description";
$config['lproposal_max_approval'] = "Jumlah Maksimal Approval";
$config['lproposal_max_approval_description'] = "Jumlah Maksimal Approval Description";

//wording request training
$config['request_viewoptions'] = "View Options";
$config['request_list'] = "List Request";
$config['request_approval'] = "List Request Approval";
$config['request_training'] = "Training Request";
$config['request_description'] = "Isi deskripsi training request di sini";
$config['request_sortlist'] = "Sort list by";
$config['request_sortlistname'] = "Name";
$config['request_add'] = "Add Data";
$config['request_export'] = "Export";
$config['request_no'] = "No.";
$config['request_namatraining'] = "Nama Training";
$config['request_namapemohon'] = "Nama Pemohon";
$config['request_typetraining'] = "Type Training";
$config['request_statusapproval'] = "Status Approval";
$config['request_newproposaltraining'] = "New Proposal Training";
$config['request_trainingtype'] = "Training Type";
$config['request_pelatihaninhouse'] = "Pelatihan Inhouse";
$config['request_pelatihaneksternal'] = "Pelatihan Eksternal";
$config['request_onthejobtraining'] = "On The Job Training";
$config['request_penyelenggara'] = "Penyelenggara";
$config['request_tema'] = "Tema";
$config['request_judul'] = "Judul";
$config['request_tanggal'] = "Tanggal";
$config['request_waktu'] = "Waktu";
$config['request_tempat'] = "Tempat";
$config['request_pembicara'] = "Pembicara";
$config['request_datapeserta'] = "Data Peserta";
$config['request_divisi'] = "Divisi";
$config['request_nohandphone'] = "No. Handphone";
$config['request_tujuanpelatihan'] = "Tujuan Pelatihan";
$config['request_rekomendasidirectsupervisor'] = "Rekomendasi (Direct Supervisor)";
$config['request_biayaprogram'] = "Biaya Program";
$config['request_akomodasi'] = "Akomodasi";
$config['request_transportasi'] = "Transportasi";
$config['request_uangmakan'] = "Uang Makan";
$config['request_rekomendasiprogramdevelopment'] = "Rekomendasi (Program Development)";
$config['request_jenispendidikan'] = "Jenis Pendidikan";
$config['request_technicalsoftskill'] = "Technical Skill / Soft Skill";
$config['request_bicategory'] = "BI Category";
$config['request_inputerror'] = "Input error";

$config['lnama_atasan'] = "Nama Atasan";

//login base lang
$config['login_welcome_back'] = "Welcome Back!";
$config['login_please_login'] = "Please Login";
$config['login_nik'] = "NIK";
$config['login_email'] = "Email";
$config['login_password'] = "Password";
$config['login_forgot_password'] = "Forgot Password?";
$config['login_button_login'] = "Login";
$config['login_choose_language'] = "Choose Language";