        ...
        if ($params['resource_type'] == 'file') {
            if (!preg_match('/^([\/\\\\]|[a-zA-Z]:[\/\\\\])/', $params['resource_name'])) {
                ...
                foreach ((array)$params['resource_base_path'] as $_curr_path) {
                    $CI =& get_instance();
                    $theme_path = sprintf("%s../theme%s%s%sviews", BASEPATH, DIRECTORY_SEPARATOR, $CI->config->item("theme"), DIRECTORY_SEPARATOR);
                    
                    $_fullpath = $theme_path . DIRECTORY_SEPARATOR . $params['resource_name'];
